...
"#,
        ...
        (
            "svc/GET/api/inject-fault.guard.yml",
            r#"
declaration:
...
"#,
        ...
        (
            "svc/GET/api/inject-fault/trigger.yml",
            r#"
...
"#,
        ...
        (
            "svc/GET/api/careful/action.yml",
            r#"
...
"#,
        ...
        (
            "svc/GET/api/inject-fault/x.yml",
            r#"
...
async fn in_folder_guard_doesnt_protect_sibling_folders() {
    let router = build(&[
        (
            "svc/GET/locked/.guard.yml",
            r#"
deny: { status: 401, return: { error: "locked" }, next: end }
"#,
        ),
        (
            "svc/GET/locked/x.yml",
            r#"
